                            ...
                            <div class="card-body" data-select2-id="12">
                                <div class="p-3 mb-4 border">
                                    ...
                                    <form action="{{ route('profile.update') }}" method="post" class="form-horizontal"
                                        data-select2-id="11" enctype="multipart/form-data">
                                        @csrf
                                        @method('patch')
                                        ...
                                        <div class="form-group ">
                                            <div class="row row-sm">
                                                ...
                                                <div class="col-md-9">
                                                    <input type="file" class="form-control" placeholder="Foto Profil"
                                                        name="photo_path" accept="iamge/*">
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="p-3 mb-4 border">
                                    ...
                                    <form action="{{ route('password.update') }}" class="form-horizontal" method="post">
                                        ...
                                        <button type="submit" class="btn btn-primary rounded-5">Perbaharui
                                            Sandi</button>
                                    </form>
