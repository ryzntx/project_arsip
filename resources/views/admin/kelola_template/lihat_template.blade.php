                        ...
                        <div class="row">
                            <div class="col-sm-15 col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama_dokumen" class="form-control" readonly disabled
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="{{ route('admin.template_dokumen.delete', $data->id) }}" class="btn btn-outline btn-danger">Ya,
                    Hapus!</a>
