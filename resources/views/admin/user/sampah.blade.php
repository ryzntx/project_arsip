                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-sm btn-info"
                                                    onclick="showRestore({{ $data->id }}, '{{ $data->name }}')">
    ...
    <script>
        function showDelete(id, name) {
            Swal.fire({
                ...
                text: "Menghapus Data" + " " + name + " Secara Permanen",
                icon: "warning",
                ...
                if (result.isConfirmed) {
                    window.location.href = "{{ url('/admin/kelola_user/sampah/delete/') }}/" + id;
                    Swal.fire({
                        title: "Hapus Data!",
        ...
        function showRestore(id, name) {
            Swal.fire({
                title: "Apakah Anda yakin?",
                text: "Mengembalikan Data" + " " + name,
                icon: "warning",
                showCancelButton: true,
                confirmButtonColor: "#3085d6",
                cancelButtonColor: "#d33",
                ...
                if (result.isConfirmed) {
                    window.location.href = "{{ url('/admin/kelola_user/sampah/restore/') }}/" + id;
                    Swal.fire({
