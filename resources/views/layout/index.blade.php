...
<head>
    ...
    <style>
        ...
        .log-data-container {
            ...
            max-width: 100%;
            /* Pastikan tidak melebihi lebar modal */
            overflow: auto;
            /* Scroll jika konten panjang */
            white-space: pre-wrap;
            /* Jaga format JSON tetap rapi */
            word-wrap: break-word;
            /* Pecah kata jika terlalu panjang */
            background: #f8f9fa;
            /* Warna latar agar lebih rapi */
            padding: 15px;
            /* Tambahkan padding biar ada jarak */
            border-radius: 5px;
            border: 1px solid #ddd;
            font-size: 14px;
            /* Perkecil font agar lebih kompak */
        }

        /* Supaya modal punya jarak di kanan */
        .modal-body {
                                    ...
                                    <a class="d-flex" href="#">
                                        <span class="main-img-user">
                                            @if (auth()->user()->photo_path == null || auth()->user()->photo_path == '')
                                                <img alt="avatar" src="{{ asset('assets/img/users/1.jpg') }}">
                                            @else
                                                <img alt="avatar"
                                    ...
                                    <div class="dropdown-menu">
                                        ...
                                        @if (auth()->user()->role == 'admin')
                                            <a class="dropdown-item" href="{{ route('admin.log') }}">
                                                <i class="fe fe-file"></i> Log Aktivitas
                                            </a>
                                        @endif
                                        <form method="POST" action="{{ route('logout') }}"
                                            class="px-0 mx-0 dropdown-item">
                                            @csrf
                                            <button type="submit" class="dropdown-item"><i class="fe fe-power"></i>
                                                Sign
                                                Out</button>
                                        </form>
                                    </div>
